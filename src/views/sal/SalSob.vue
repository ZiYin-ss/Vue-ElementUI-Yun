  ...
  <div>
    ...
    <el-dialog :title="dialogTitle" :visible.sync="dialogVisible" width="50%">
      <div style="justify-content: space-around;align-items:center;display: flex">
        ...
        <el-input v-model="salary[title]"  v-show="activeItemIndex===index" style="width: 200px;" :placeholder="'请输入'+salaryItemName[index]+'...'"  v-for="(value,title,index) in salary"></el-input>
      </div>
